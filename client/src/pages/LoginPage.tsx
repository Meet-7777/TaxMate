...
export default function LoginPage() {
  ...
  // Already authenticated (e.g. other tab logged in, storage event fired) → go to dashboard.
  // Don't redirect while still loading — wait for restoreSession to finish first.
